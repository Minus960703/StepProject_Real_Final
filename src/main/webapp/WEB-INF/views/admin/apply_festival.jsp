                        ...
                        <form method="post" action="write">
                            <div>
								...
								%>
									...
									<div>승인여부 <%
											if(vo.getCheckcode().equals("Y")){
												%>
												<a href="http://localhost:8085/admin/apply_festivalDB?no=<%=vo.getNo()%>&checkcode=Y">수락 </a>,<a href="http://localhost:8085/admin/apply_festivalDB?no=<%=vo.getNo()%>&checkcode=N">거절</a> <br><br>
												<%
											}
											else{
											%>
